...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppController = __webpack_require__(30);
	
	var AppController = _interopRequireDefault(_AppController).default;
	
	var _AppRouter = __webpack_require__(98);
	...
	var _infoModal = __webpack_require__(11);
	...
	var appController = new AppController({ app: app });
	...
	// for development
	window.user = common.user;
	window.topics = common.topicCollection;
	
	app.addInitializer(function (options) {
	    document.addEventListener("deviceready", onDeviceReady, false);
	    function onDeviceReady() {
	        if (window.cordova.platformId == "browser") {
	            facebookConnectPlugin.browserInit("1871067949796909");
	        } else {
	            ...
	            SocialVk.init("5509788", function (result) {
	                console.log(result);
	...
	app.start();
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(9), __webpack_require__(4)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4), __webpack_require__(5), __webpack_require__(7), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.topicCollection = exports.user = exports.emailRegexp = exports.api = exports.ValidateModel = undefined;
	
	var _serverAPI = __webpack_require__(10);
	
	var serverApi = _interopRequireDefault(_serverAPI).default;
	
	var _validateModel = __webpack_require__(22);
	...
	var _topicCollection = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ajaxController(data) {
	  ...
	  $.ajax({
	    ...
	    new infoModal({ message: 'Что то пошло не так' }).showModal();
	  });
	...
	exports.default = {
	  ...
	  startRandomGameByTopicId: function startRandomGameByTopicId(topicId) {
	    return ajaxController({
	      action: 'start_game',
	      topic_id: topicId
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _infoModal = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	}); // import common from 'commonObj';
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(6), __webpack_require__(9)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"modal-overflow\"><div class=\"modal-backdrop\"></div><div class=\"modal-content\"><div class=\"modal-body\"><p>" + (jade.escape((jade_interp = message) == null ? '' : jade_interp)) + "</p><div class=\"form-container\"><div data-js-ok class=\"form-button\">ok</div></div></div></div></div>");}.call(this,"message" in locals_for_with?locals_for_with.message:typeof message!=="undefined"?message:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(23), __webpack_require__(9), __webpack_require__(5)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = Epoxy.Model.extend({
	  ...
	  parseAnswer: function parseAnswer(data) {
	    this.set({
	      name: data.answer.u_login,
	      id: data.answer.u_id,
	      rate: data.answer.u_rate,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _topicModel = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = Marionette.Object.extend({
	  initialize: function initialize(options) {
	    ...
	    this.app.addRegions({
	      appRegion: ".container_overflow"
	    });
	    this.appLayout = new AppLayout();
	    this.app.getRegion('appRegion').show(this.appLayout);
	  ...
	  showOutsidePage: function showOutsidePage(pageConstructor) {
	    if (!common.user.get('auth')) {
	      this.appLayout.showPage(pageConstructor);return;
	    }
	    common.router.navigate('index', { trigger: true });
	  },
	  showInsidePage: function showInsidePage(pageConstructor) {
	    if (common.user.get('auth')) {
	      this.appLayout.showPage(pageConstructor);return;
	    }
	    common.router.navigate('', { trigger: true });
	  ...
	  onShowSelectTopic: function onShowSelectTopic() {
	    this.showInsidePage(selectTopicPage);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppLayout = __webpack_require__(32);
	...
	exports.default = Marionette.LayoutView.extend({
	  ...
	  initialize: function initialize() {
	    this.pageRegion = this.getRegion('page');
	    this.modalRegion = this.getRegion('modal');
	  },
	  ...
	  showPage: function showPage(pageConstructor) {
	    ...
	    var curView = this.pageRegion.currentView;
	    var newView = new pageConstructor(options);
	    if (curView) {
	      curView.$el.removeClass('show');
	      setTimeout(function () {
	        curView.destroy();
	      }, 500);
	    }
	    this.pageRegion.show(newView, { preventDestroy: true });
	    newView.$el.width();
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div id=\"header-container\"></div><div id=\"page-container\"></div><div id=\"footer-container\"></div><div id=\"modal-container\"></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _youWaitingWidget = __webpack_require__(40);
	
	var youWaitingWidget = _interopRequireDefault(_youWaitingWidget).default;
	
	var _offersWidget = __webpack_require__(46);
	
	var offersWidget = _interopRequireDefault(_offersWidget).default;
	
	var _finishedGameWidget = __webpack_require__(50);
	
	var finishedGameWidget = _interopRequireDefault(_finishedGameWidget).default;
	...
	exports.default = MarionetteEpoxy.LayoutView.extend({
	  ...
	  events: {
	    ...
	    'click @ui.buttonSettings': 'onClickButtonSettings',
	  ...
	  regions: {
	    youWaiting: '[data-js-you-waiting-widget]',
	    offers: '[data-js-offers-widget]',
	    finishedGame: '[data-js-finished-game-widget]'
	  },
	  ...
	  onRender: function onRender() {
	    this.youWaiting.show(new youWaitingWidget());
	    this.offers.show(new offersWidget());
	    this.finishedGame.show(new finishedGameWidget());
	  },
	  onClickLogout: function onClickLogout() {
	    common.user.logout();
	  },
	  onClickButtonSettings: function onClickButtonSettings() {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(36), __webpack_require__(9)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LayoutView = exports.View = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<h1>Вы вошли как&nbsp;<span data-js-user-name></span></h1><form class=\"form-container\"><div data-js-settings class=\"form-button\">Настройки</div><div data-js-logout class=\"form-button\">Разлогиниться</div><br><div data-js-new-game class=\"form-button\">Новая игра</div><br></form><div data-js-offers-widget></div><div data-js-you-waiting-widget></div><div data-js-finished-game-widget></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _youWaitingWidget = __webpack_require__(41);
	
	var template = _interopRequireDefault(_youWaitingWidget).default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div><div class=\"nameWidget\"><p class=\"block\">Ждем</p><div class=\"close block\"></div></div><div class=\"ramka\"><div class=\"icon\"></div><div class=\"info\"><div class=\"nameGame\"><div class=\"title\"><p>4 минуты</p></div><div class=\"playerName\"><p>Player</p></div><div class=\"itog\"><p>2 - 3</p></div></div></div></div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _offersWidget = __webpack_require__(47);
	
	var template = _interopRequireDefault(_offersWidget).default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var x = 2;
	buf.push("<div><div class=\"nameWidget\"><p class=\"block\">Наш ход</p><div class=\"close block\"></div></div></div>");
	for (var i=1; i<=x; i++) {
	{
	buf.push("<div class=\"ramka\"><div class=\"icon\"></div><div class=\"info\"><div class=\"nameGame\"><div class=\"title\"><p>Ваш ход против</p></div><div class=\"playerName\"><p>Player</p></div><div class=\"itog\"><p>2 - 3</p></div></div></div></div>");
	}
	};return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _finishedGameWidget = __webpack_require__(51);
	
	var template = _interopRequireDefault(_finishedGameWidget).default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div><div class=\"nameWidget\"><p class=\"block\">Завершенные игры</p><div class=\"close block\"></div></div><div class=\"ramka\"><div class=\"icon\"></div><div class=\"info\"><div class=\"nameGame\"><div class=\"title\"><p>Ваша игра против</p></div><div class=\"playerName\"><p>Player</p></div><div class=\"itog\"><p>Вы 2 - 3 Player</p></div></div></div></div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buyModal = __webpack_require__(55);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buyModal = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<form class=\"form-container\"><div data-js-account-settings class=\"form-button\">Настройки аккаунта</div><div data-js-change-avatar class=\"form-button\">Изменить аватар</div><div data-js-change-avatar class=\"form-button\">Изменить дизайн</div><div data-js-buy class=\"form-button\">Купить премиум</div></form>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newGamePage = __webpack_require__(63);
	...
	exports.default = MarionetteEpoxy.View.extend({
	  ...
	  onClickRandom: function onClickRandom() {
	    common.api.checkRandomGame().done(function (data) {
	      ...
	      common.router.navigate('selecttopic', { trigger: true });
	    });
	  }
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(36), __webpack_require__(9)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<form class=\"form-container\"><div data-js-search-rival class=\"form-button\">Найти соперника</div><div data-js-new-game-fb class=\"form-button\">Новая игра FB</div><div data-js-new-game-vk class=\"form-button\">Новая игра VK</div><div data-js-random-rival class=\"form-button\">Случайный соперник</div><div data-js-last20-games class=\"form-button\">20 последних игр</div></form>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(MarionetteEpoxy, Marionette, _, $) {'use strict';
	
	Object.defineProperty(exports, "__esModule", {
	    value: true
	});
	
	var _searchUserPage = __webpack_require__(67);
	
	var template = _interopRequireDefault(_searchUserPage).default;
	
	var _rivalItem = __webpack_require__(68);
	
	var rivalTemplate = _interopRequireDefault(_rivalItem).default;
	
	__webpack_require__(69);
	
	var _rivalCollection = __webpack_require__(71);
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(36), __webpack_require__(3), __webpack_require__(5), __webpack_require__(6)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<form class=\"form-container\"><input type=\"text\" name=\"name\" placeholder=\"Нажмите здесь для поиска\" data-js-user-name class=\"form-input\"><div class=\"result-container\"></div></form>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<h1>" + (jade.escape((jade_interp = name) == null ? '' : jade_interp)) + "</h1>");}.call(this,"name" in locals_for_with?locals_for_with.name:typeof name!=="undefined"?name:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rivalModel = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _last20gamesPage = __webpack_require__(74);
	...
	exports.default = MarionetteEpoxy.View.extend({
	    template: template,
	    className: 'last20games-page page',
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<h1>Вы вошли как&nbsp;<span data-js-user-name></span></h1>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectTopicPage = __webpack_require__(78);
	
	var template = _interopRequireDefault(_selectTopicPage).default;
	
	__webpack_require__(79);
	
	var _topicItem = __webpack_require__(81);
	...
	exports.default = MarionetteEpoxy.LayoutView.extend({
	  template: template,
	  className: 'select-topic-page page',
	  ...
	  onSelectTopic: function onSelectTopic(topic) {
	    console.dir(topic);
	    common.api.startRandomGameByTopicId(topic.get('topic_id'));
	  }
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(36), __webpack_require__(3), __webpack_require__(9)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<h1>Выберите тему</h1><form data-js-topic-container class=\"form-container\"></form>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<" + (t_name) + "></" + (t_name) + ">");}.call(this,"t_name" in locals_for_with?locals_for_with.t_name:typeof t_name!=="undefined"?t_name:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _authPage = __webpack_require__(83);
	...
	exports.default = MarionetteEpoxy.View.extend({
	    ...
	    onClickVk: function onClickVk() {
	        SocialVk.login([], function (result) {
	            console.log(result);
	            new infoModal({ message: "UserInfo: " + _JSON$stringify(result) }).showModal();
	        }, function (error) {
	            console.log(error);
	    ...
	    onClickFb: function onClickFb() {
	        facebookConnectPlugin.login(["public_profile"], function (userData) {
	            ...
	            new infoModal({ message: "UserInfo: " + _JSON$stringify(userData) }).showModal();
	        }, function (error) {
	            console.log(error);
	            new infoModal({ message: '' + error }).showModal();
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"form-container\"><div data-js-vk class=\"form-button\">Войти в VK</div><div data-js-fb class=\"form-button\">Войти в FB</div><div data-js-registration class=\"form-button\">Создать аккаунт</div><div data-js-signin class=\"form-button\">Войти</div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _registrationPage = __webpack_require__(87);
	...
	exports.default = MarionetteEpoxy.View.extend({
	  ...
	  onFormSubmit: function onFormSubmit(e) {
	    ...
	    if (this.model.validate()) {
	      common.api.registration(this.model.get('login'), this.model.get('email'), this.model.get('password')).done(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<form class=\"form-container\"><input type=\"text\" name=\"login\" placeholder=\"Логин\" data-js-login class=\"form-input\"><input type=\"email\" name=\"email\" placeholder=\"E-mail\" data-js-email class=\"form-input\"><input type=\"password\" name=\"password\" placeholder=\"Пароль\" data-js-password class=\"form-input\"><input type=\"password\" name=\"passwordRepeat\" placeholder=\"Повторите пароль\" data-js-password-repeat class=\"form-input\"><input type=\"submit\" value=\"Создать\" data-js-registration class=\"form-button\"></form>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signinPage = __webpack_require__(91);
	...
	exports.default = MarionetteEpoxy.View.extend({
	  ...
	  onFormSubmit: function onFormSubmit(e) {
	    e.preventDefault();
	    common.api.signIn(this.ui.login.val(), this.ui.password.val()).done(function (data) {
	      common.user.parseAnswer(data);
	      common.router.navigate('index', { trigger: true });
	    }).fail(function (err) {
	      new infoModal({ message: err.text }).showModal();
	  ...
	  onClickGuest: function onClickGuest() {
	    common.api.signInGuest().done(function (data) {
	      common.user.parseAnswer(data);
	      common.router.navigate('index', { trigger: true });
	    }).fail(function (err) {
	      new infoModal({ message: err.text }).showModal();
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<form class=\"form-container\"><input type=\"text\" name=\"login\" placeholder=\"Логин\" data-js-login class=\"form-input\"><input type=\"password\" name=\"password\" placeholder=\"Пароль\" data-js-password class=\"form-input\"><input type=\"submit\" data-js-signin value=\"Войти\" class=\"form-button\"></form><br><div class=\"form-container\"><div data-js-restore-password class=\"form-button\">Востановление пароля</div><div data-js-guest class=\"form-button\">Войти как гость</div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _restorePasswordPage = __webpack_require__(95);
	...
	exports.default = MarionetteEpoxy.View.extend({
	  ...
	  onFormSubmit: function onFormSubmit(e) {
	    ...
	    e.preventDefault();
	    if (this.model.validate()) {
	      common.api.restorePassword(this.model.get('email')).done(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<form class=\"form-container\"><input type=\"email\" name=\"email\" placeholder=\"E-mail\" data-js-email class=\"form-input\"><input type=\"submit\" data-js-restore value=\"Востановить пароль\" class=\"form-button\"></form>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	Backbone.View.prototype.delegateEvents = function (events) {
	  ...
	  var _loop = function _loop(key) {
	    ...
	    var selector = match[2];
	    if (eventName == 'click' && Modernizr.touchevents) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(5), __webpack_require__(6), __webpack_require__(4)))
...
/***/ }
/******/ ]);
//# sourceMappingURL=application.b8665da3d97fe9157d69.js.map