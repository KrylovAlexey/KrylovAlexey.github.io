...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = Marionette.Object.extend({
		...
		onShowLast20Games: function onShowLast20Games() {
			this.onShowLast20Games(last20games);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Marionette, _) {'use strict';
	...
	var View = exports.View = Marionette.ItemView.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(MarionetteEpoxy, Marionette) {'use strict';
	...
	exports.default = MarionetteEpoxy.View.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        this.rivalCollectionView = new RivalCollectionView({
	            el: this.ui.resultContainer,
	            collection: this.rivalCollection
	        });
	        this.rivalCollectionView.render();
	
	        this.epoxify();
	    }
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34), __webpack_require__(3)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<h1>test2</h1>");;return buf.join("");
	}
...
/***/ }
/******/ ]);
//# sourceMappingURL=application.ab5a5a33ef1d8ffc7560.js.map