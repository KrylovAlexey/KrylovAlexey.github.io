...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppController = __webpack_require__(223);
	
	var AppController = _interopRequireDefault(_AppController).default;
	
	var _AppRouter = __webpack_require__(372);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    createOpponentRoom: function createOpponentRoom(topicId, rivalId) {
	        return ajaxController({
	            action: 'create_room',
	            topic_id: topicId,
	    ...
	    startGameById: function startGameById(opponentId) {
	        return ajaxController({
	            action: 'start_game',
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(7), __webpack_require__(10)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = Backbone.Collection.extend({
	    ...
	    initialize: function initialize() {
	        this.listenTo(this, 'change:t_penalty', this.onChangePenalty);
	    },
	    onChangePenalty: function onChangePenalty(model, id_topic) {
	
	        if (!model.get("isBlock")) {
	            common.api.blockTopic(id_topic).done(function (data) {
	                console.log(id_topic);
	            }).fail(function (err) {
	                console.log(err.text);
	            });
	        } else {
	            common.api.unblockTopic(id_topic).done(function (data) {
	                console.log(id_topic);
	            }).fail(function (err) {
	                console.log(err.text);
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = Backbone.Collection.extend({
	    ...
	    updateStatus: function updateStatus() {
	        ...
	        common.api.getRoomsStatus(this.getRoomsId()).done(function (data) {
	            if (data && data.answer) {
	                _.each(data.answer, function (data, id) {
	                    _this3.get(id).set(data);
	                }, _this3);
	            }
	        });
	    ...
	    smartParse: function smartParse(data) {
	        ...
	        _.each(data.answer.user_games, function (user_game) {
	            if (!_this4.get(user_game.room_id)) {
	                _this4.add(_this4.getGameInfo(data, user_game));
	            }
	        });
	    },
	    parse: function parse(data) {
	        ...
	        if (data && data.answer && data.answer.user_games) {
	            this.reset(_.map(data.answer.user_games, function (user_game) {
	                return _this5.getGameInfo(data, user_game);
	            }));
	        } else {
	            this.reset([]);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = Backbone.Collection.extend({
	    ...
	    onAddItem: function onAddItem(model) {
	        ...
	        common.api.friend.add(model.get('id')).done(function () {
	            _this.update();
	        });
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = Backbone.Collection.extend({
	    ...
	    onAddItem: function onAddItem(model) {
	        ...
	        common.api.blackList.add(model.get('id')).done(function () {
	            _this.update();
	        }).fail(function (err) {
	            console.log(err.text);
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppLayout = __webpack_require__(224);
	
	var AppLayout = _interopRequireDefault(_AppLayout).default;
	
	__webpack_require__(231);
	
	var _selectTopicModal = __webpack_require__(235);
	...
	exports.default = Marionette.Object.extend({
	    ...
	    onShowGamePage: function onShowGamePage(roomId) {
	        ...
	        if (this.isAuthWhichAction()) {
	            common.userGameCollection.ready.done(function () {
	                _this2.appLayout.showPage(gamePage, { room_id: roomId });
	            });
	        }
	    },
	    ...
	    onShowGameResultPage: function onShowGameResultPage(roomId) {
	        ...
	        if (this.isAuthWhichAction()) {
	            common.userGameCollection.ready.done(function () {
	                _this3.appLayout.showPage(gameResultPage, { room_id: roomId });
	            });
	        }
	    },
	    ...
	    onShowProfileDetail: function onShowProfileDetail() {
	        this.showInsidePage(profileDetailPage);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppLayout = __webpack_require__(225);
	
	var template = _interopRequireDefault(_AppLayout).default;
	
	var _headerWidget = __webpack_require__(226);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = MarionetteEpoxy.View.extend({
	    ...
	    ui: {
	        openMenu: '[data-js-open-menu]',
	        closeMenu: '[data-js-close-menu]',
	        buttonLogout: '[data-js-logout]',
	        buttonSettings: '[data-js-settings]',
	        buttonGames: '[data-js-games]',
	        buttonFriends: '[data-js-friends]',
	        buttonBlackList: '[data-js-black-list]',
	        buttonStatistics: '[data-js-statistics]'
	    },
	
	    events: {
	        'click @ui.openMenu': 'onClickShowMenu',
	        'click @ui.closeMenu': 'onClickCloseMenu',
	        'click @ui.buttonLogout': 'onClickLogout',
	        'click @ui.buttonSettings': 'onClickSettings',
	        'click @ui.buttonGames': 'onClickGames',
	        'click @ui.buttonFriends': 'onClickFriends',
	        'click @ui.buttonBlackList': 'onClickBlackList',
	        'click @ui.buttonStatistics': 'onClickStatistics'
	    },
	    bindings: {
	        '[data-js-user-name]': 'text: login',
	        ':el': 'classes: {hide: not(auth)}'
	    },
	    ...
	    onClickShowMenu: function onClickShowMenu() {
	    ...
	    onClickFriends: function onClickFriends() {
	        this.onClickCloseMenu();
	        common.router.navigate('friends', { trigger: true });
	    },
	    ...
	    onClickStatistics: function onClickStatistics() {
	        this.onClickCloseMenu();
	        common.router.navigate('statistics', { trigger: true });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"status-bar\"><div data-js-open-menu class=\"open-menu-overflow\"><div class=\"menu-icon\"></div></div><div data-js-user-name class=\"col-xs-8 text-right\"></div></div><div class=\"container menu-container\"><div class=\"row\"><p class=\"col-xs-10 colxs-offset-1 text-center\">Вы вошли как&nbsp;<span data-js-user-name></span></p></div><div class=\"row\"><button data-js-games class=\"btn col-xs-10 col-xs-offset-1\">Мои игры</button></div><div class=\"row\"><button data-js-friends class=\"btn col-xs-10 col-xs-offset-1\">Друзья</button></div><div class=\"row\"><button data-js-black-list class=\"btn col-xs-10 col-xs-offset-1\">Черный список</button></div><div class=\"row\"><button data-js-settings class=\"btn col-xs-10 col-xs-offset-1\">Настройки</button></div><div class=\"row\"><button data-js-statistics class=\"btn col-xs-10 col-xs-offset-1\">Статистика</button></div><div class=\"row\"><button data-js-logout class=\"btn col-xs-10 col-xs-offset-1\">Выйти</button></div></div><div data-js-close-menu class=\"back-menu\"></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectTopicModal = __webpack_require__(236);
	
	var template = _interopRequireDefault(_selectTopicModal).default;
	
	__webpack_require__(237);
	
	var _topicItem = __webpack_require__(239);
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(227), __webpack_require__(4), __webpack_require__(10)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _indexPage = __webpack_require__(241);
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(227), __webpack_require__(10), __webpack_require__(24)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gamesPage = __webpack_require__(246);
	
	var template = _interopRequireDefault(_gamesPage).default;
	
	__webpack_require__(247);
	
	var _userGameItem = __webpack_require__(249);
	
	var userGameTemplate = _interopRequireDefault(_userGameItem).default;
	
	var _userGameCollection = __webpack_require__(250);
	
	var userGameCollection = _interopRequireDefault(_userGameCollection).default;
	
	var _answerModal = __webpack_require__(251);
	...
	exports.default = MarionetteEpoxy.LayoutView.extend({
	    ...
	    regions: {
	        gameList: '[data-js-user-game-list]',
	        gameList2: '[data-js-user-game-list2]',
	        gameList3: '[data-js-user-game-list3]'
	    },
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(227), __webpack_require__(10), __webpack_require__(6), __webpack_require__(7)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _answerModal = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buyModal = __webpack_require__(256);
	
	var buyModal = _interopRequireDefault(_buyModal).default;
	
	var _settingsPage = __webpack_require__(260);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buyModal = __webpack_require__(257);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _changeAvatarPage = __webpack_require__(264);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newGamePage = __webpack_require__(272);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchUserPage = __webpack_require__(276);
	
	var template = _interopRequireDefault(_searchUserPage).default;
	
	var _rivalItem = __webpack_require__(277);
	...
	var _rivalCollection = __webpack_require__(280);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rivalModel = __webpack_require__(281);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _last20gamesPage = __webpack_require__(283);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gamePage = __webpack_require__(287);
	...
	var _roundWidget = __webpack_require__(290);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _roundWidget = __webpack_require__(291);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ((item == '0'))
	{
	buf.push("<img" + (jade.attr("src", __webpack_require__(292), true, true)) + " class=\"icon-score column line-height\">");
	}
	else
	{
	buf.push("<img" + (jade.attr("src", __webpack_require__(293), true, true)) + " class=\"icon-score colum line-height\">");
	}
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profilePage = __webpack_require__(297);
	...
	exports.default = MarionetteEpoxy.View.extend({
	    template: template,
	    className: 'profile-page page bg-blur load',
	    ...
	    bindings: {
	        ...
	        '[data-js-profile-ratePos]': 'text: u_rate_pos',
	        '[data-js-profile-allGame]': 'text: u_allGame',
	    ...
	    renderRoundsInfo: function renderRoundsInfo(data) {
	        ...
	        var rate = data.answer.u_rate;
	        var win = data.answer.u_win;
	        var rate_pos = data.answer.u_rate_pos;
	        var allGame = 0;
	        allGame = +data.answer.u_win + +data.answer.u_lose + +data.answer.u_draw;
	        var login = data.answer.u_login;
	
	        var topics_answers = data.answer.topics_answers;
	        ...
	        this.model.set({
	            ...
	            u_allGame: allGame,
	            u_login: login,
	            topics_answers: topics_answers,
	            u_id: this.userId
	        });
	        common.opponent = this.model;
	        this.checkFriend();
	        this.checkInBlackList();
	    },
	    checkFriend: function checkFriend() {
	        var self = this;
	        common.friendCollection.ready.done(function () {
	            if (common.friendCollection.get(self.model.get('u_id'))) {
	                self.ui.buttonAddFriend.addClass('disabled');
	    ...
	    onClickButtonDetail: function onClickButtonDetail() {
	        common.router.navigate('profileDetail', { trigger: true });
	    },
	    onClickAddFriend: function onClickAddFriend() {
	        common.friendCollection.add({ id: this.model.get('u_id') });
	        this.checkFriend();
	    },
	    checkInBlackList: function checkInBlackList() {
	        var self = this;
	        common.blackListCollection.ready.done(function () {
	            if (common.blackListCollection.get(self.model.get('u_id'))) {
	                self.ui.buttonAddBlackList.addClass('disabled');
	                self.ui.buttonAddFriend.addClass('disabled');
	            }
	        });
	    ...
	    onClickAddBlackList: function onClickAddBlackList() {
	        common.blackListCollection.add({ id: this.model.get('u_id') });
	        this.checkInBlackList();
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"scroll-content\"><div class=\"table-middle-block\"><div class=\"table-middle-cell\"><div class=\"container\"><div class=\"row\"><div class=\"icon avatar-icon profile-center\"></div><p data-js-profile-login class=\"col-xs-10 col-xs-offset-1 profile-center yellow-text b\">Логин</p></div><div class=\"row profile-center\"><div class=\"col-xs-3 col-xs-offset-2\"><div class=\"icon win-icon\"></div><span class=\"profile-center sub-text b\">Побед</span><br><span data-js-profile-win class=\"profile-center score-text b\">100500</span></div><div class=\"col-xs-2\"></div><div class=\"col-xs-4 right-col\"><div class=\"icon all_game-icon\"></div><span class=\"profile-center sub-text b\">Всего игр</span><br><span data-js-profile-allGame class=\"profile-center score-text b\">100500</span></div></div><div class=\"row profile-center\"><div class=\"col-xs-3 col-xs-offset-2\"><div class=\"icon score-icon\"></div><span class=\"profile-center sub-text b\">Очки</span><br><span data-js-profile-rate class=\"profile-center score-text b\">100500</span></div><div class=\"col-xs-2\"></div><div class=\"col-xs-4 right-col\"><div class=\"icon position-icon\"></div><span class=\"profile-center sub-text b\">Позиция</span><br><span data-js-profile-ratePos class=\"profile-center score-text b\">100500</span></div></div><br><br><div class=\"row\"><button data-js-profile-detail class=\"btn col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3\"><span>Больше информации</span></button></div><div class=\"row\"><button class=\"btn col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3\"><span>Написать в чат</span></button></div><div class=\"row\"><button data-js-add-friend class=\"btn col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3\"><span>Добавить в друзья</span></button></div><div class=\"row\"><button data-js-add-blackList class=\"btn col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3\"><span>Добавить в черный список</span></button></div><div class=\"row\"><button data-js-start-game class=\"btn col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3\"><span>Сразиться</span></button></div></div></div></div></div><div class=\"loading-block\"><div class=\"loading-icon\"></div><div class=\"text-block\"><p>Идет загрузка</p><p>Пожалуйста, подождите</p></div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameResultPage = __webpack_require__(305);
	...
	exports.default = MarionetteEpoxy.View.extend({
	    ...
	    initialize: function initialize(options) {
	        ...
	        common.api.room.result([this.roomId]).done(function (data) {
	            _this.model.set({
	                opponentScore: data.answer.rooms_results[_this.roomId][_this.model.get('opponentId')].scores,
	                userScore: data.answer.rooms_results[_this.roomId][common.user.get('id')].scores
	            });
	        });
	        this.epoxify();
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"scroll-content\"><div class=\"table-middle-block\"><div class=\"table-middle-cell\"><div class=\"container\"><div class=\"row main-block\"><div class=\"half-block\"><div data-js-user-icon class=\"user-icon\"><div class=\"avatar_bg\"></div><div class=\"avatar\"></div></div><h2 data-js-user-name class=\"yellow-text\"></h2></div><div class=\"half-block\"><div data-js-opponent-icon class=\"user-icon\"><div class=\"avatar_bg\"></div><div class=\"avatar\"></div></div><h2 data-js-opponent-name class=\"yellow-text\"></h2></div><div class=\"score-block yellow-text\"><span data-js-user-score></span>&nbsp;:&nbsp;<span data-js-opponent-score></span></div></div><br><div class=\"row\"><div class=\"btn-set col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 p-l-0 p-r-0\"><div data-js-play class=\"btn col-xs-6\">Реванш</div><div data-js-history class=\"btn col-xs-6\">История поединка</div></div></div></div></div></div></div><div class=\"loading-block\"><div class=\"loading-icon\"></div><div class=\"text-block\"><p>Идет загрузка</p><p>Пожалуйста, подождите</p></div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _questionsPage = __webpack_require__(309);
	...
	var _questionWidget = __webpack_require__(312);
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"scroll-content\"><div class=\"table-middle-block\"><div class=\"table-middle-cell\"><div data-js-question-container></div></div></div></div><div class=\"loading-block\"><div class=\"loading-icon\"></div><div class=\"text-block\"><p>Идет загрузка</p><p>Пожалуйста, подождите</p></div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _questionWidget = __webpack_require__(313);
...
/***/ function(module, exports, __webpack_require__) {
	...
	{
	buf.push("<div" + (jade.attr("data-id", "" + (answer.id) + "", true, true)) + " class=\"btn correct\">" + (jade.escape((jade_interp = answer.a_text) == null ? '' : jade_interp)) + "</div>");
	}
	else
	{
	buf.push("<div" + (jade.attr("data-id", "" + (answer.id) + "", true, true)) + " class=\"btn\">" + (jade.escape((jade_interp = answer.a_text) == null ? '' : jade_interp)) + "</div>");
	}
	buf.push("</div>");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _questionModel = __webpack_require__(318);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _friendsPage = __webpack_require__(320);
	...
	var _friendItem = __webpack_require__(323);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _blackListPage = __webpack_require__(325);
	...
	var _blackListItem = __webpack_require__(328);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _settingsPageAcc = __webpack_require__(330);
	...
	var _enterPasswordModal = __webpack_require__(333);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _enterPasswordModal = __webpack_require__(334);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _statisticsPage = __webpack_require__(338);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _playerRankingsPage = __webpack_require__(342);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _authPage = __webpack_require__(346);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _registrationPage = __webpack_require__(352);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _blockTopicsPage = __webpack_require__(356);
	
	var template = _interopRequireDefault(_blockTopicsPage).default;
	
	__webpack_require__(357);
	
	var _blockTopicsItem = __webpack_require__(359);
	...
	var BlockTopicsItemView = MarionetteEpoxy.View.extend({
	    ...
	    tagName: 'li',
	    className: 'blockTopics-item',
	    ui: {
	        removeButton: '[data-js-remove]'
	    },
	    bindings: {
	        '[data-js-block-topics-name]': 'text: t_name'
	    },
	    events: {
	        'click [data-js-block-topics-button]': 'onClickBlockTopic'
	    },
	    initialize: function initialize() {
	        this.epoxify();
	    },
	    onClickBlockTopic: function onClickBlockTopic() {
	        this.model.set('t_penalty', this.model.get("id"));
	    }
	});
	...
	var BlockTopicsCollectionView = MarionetteEpoxy.CompositeView.extend({
	    ...
	    onClickTopic: function onClickTopic(view, topic) {
	        this.trigger('click:topic', topic);
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"scroll-content\"><div class=\"table-middle-block\"><div class=\"table-middle-cell\"><div class=\"container\"><div class=\"row\"><button class=\"btn col-xs-10 col-xs-offset-1\"><span>Заблокировать тему</span></button></div><div class=\"row\"><div class=\"col-xs-10 col-xs-offset-1 yellow-text\"><span>Заблокированные темы1236666666</span></div></div><div class=\"row\"><ul data-js-block-topics-list class=\"list-container\"></ul></div></div></div></div></div><div class=\"loading-block\"><div class=\"loading-icon\"></div><div class=\"text-block\"><p>Идет загрузка</p><p>Пожалуйста, подождите</p></div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div data-js-block-topics-button class=\"text-container\"><div class=\"table-middle-block\"><div class=\"table-middle-cell\"><p data-js-block-topics-name>Название категории</p></div></div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signinPage = __webpack_require__(361);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _restorePasswordPage = __webpack_require__(365);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profileDetailPage = __webpack_require__(369);
	...
	exports.default = MarionetteEpoxy.View.extend({
	    template: template,
	    className: 'profileDetail-page page bg-blur',
	
	    ui: {
	        'profileDetailContainer': '[data-js-profileDetail-container]'
	    },
	    events: {},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade_mixins = {};
	var jade_interp;
	;var locals_for_with = (locals || {});(function (Math, common, undefined) {
	buf.push("<div class=\"scroll-content\"><div class=\"table-middle-block\"><div class=\"table-middle-cell\"><div class=\"container\"><div class=\"row\"><div class=\"icon avatar-icon profile-center\"></div><p data-js-profile-login class=\"col-xs-10 col-xs-offset-1 profileDetail-center yellow-text b\">Логин1</p></div><br><br><div class=\"row yellow-text\"><p class=\"col-xs-10 col-xs-offset-1 padding0\">Награды</p></div><div class=\"row profile-center\"><div class=\"col-xs-2 col-xs-offset-1 padding0\"><div class=\"icon win-icon\"></div></div><div class=\"col-xs-2 padding0\"><div class=\"icon win-icon\"></div></div><div class=\"col-xs-2 padding0\"><div class=\"icon win-icon\"></div></div><div class=\"col-xs-2 padding0\"><div class=\"icon win-icon\"></div></div><div class=\"col-xs-2 padding0\"><div class=\"icon win-icon\"></div></div></div><div class=\"row profile-center\"><div class=\"col-xs-2 col-xs-offset-1 padding0\"><div class=\"icon win-icon\"></div></div><div class=\"col-xs-2 padding0\"><div class=\"icon win-icon\"></div></div><div class=\"col-xs-2 padding0\"><div class=\"icon win-icon\"></div></div><div class=\"col-xs-2 padding0\"><div class=\"icon win-icon\"></div></div><div class=\"col-xs-2 padding0\"><div class=\"icon win-icon\"></div></div></div><div class=\"row yellow-text\"><p class=\"col-xs-12\">Категория(% правильный ответов)</p></div>");
	// iterate common.opponent.attributes.topics_answers
	;(function(){
	  var $$obj = common.opponent.attributes.topics_answers;
	  if ('number' == typeof $$obj.length) {
	
	    for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
	      var topics = $$obj[$index];
	...
	buf.push("</div></div></div></div><div class=\"loading-block\"><div class=\"loading-icon\"></div><div class=\"text-block\"><p>Идет загрузка</p><p>Пожалуйста, подождите</p></div></div>");}.call(this,"Math" in locals_for_with?locals_for_with.Math:typeof Math!=="undefined"?Math:undefined,"common" in locals_for_with?locals_for_with.common:typeof common!=="undefined"?common:undefined,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined));;return buf.join("");
	}
...
/***/ }
/******/ ]);
//# sourceMappingURL=application.95677aca035452c5442f.js.map